...
/**
 * Provides the GUI and encapsulates the DrawPanel It creates 3 buttons undo, redo and clear. It creates 2 combobox colors and shapes. It creates 1 checkbox
 * filled to select whether shape is filled or not. Has two private inner classes One for handling button events Another for handling both combo box events and
 * checkbox events
 */
public class DrawFrame extends JFrame {
    ...
    /**
     * This constructor sets the name of the JFrame. It also creates a DrawPanel object that extends JPanel for drawing the shapes and contains a statuslabel
     * for mouse position. Initializes widgets for buttons, comboboxes and checkbox It also adds event handlers for the widgets
     */
    public DrawFrame() {
        super("SuperPaint Application v2.5!"); //sets the name of DrawFrame
